<?php
	...
	class admin_categories {
		...
		public static function categoryList() {
			...
			views::set('categories', $categoryModel->getAllWithParentName());
			views::view('kibrissiparisAdmin/categories/list.cshtml');
		}
		...
		public static function add() {
			...
			views::view('kibrissiparisAdmin/categories/add.cshtml', $viewBag);
		}
		...
		public static function delete($actionName, $categoryID) {
			...
			$viewBag = array('categories' => $categoryModel->getAllWithParentName());
			views::view('kibrissiparisAdmin/categories/list.cshtml', $viewBag);
		}
